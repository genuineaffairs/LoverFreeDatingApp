...
import com.brl.loverfreedatingapp.Accounts.Enable_location_F;
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            if(sharedPreferences.getString(Variables.Lat,"").equals("") || sharedPreferences.getString(Variables.Lon,"").equals("") ){
                            SharedPreferences.Editor editor=sharedPreferences.edit();
