package com.brl.loverfreedatingapp.Profile;
...
import com.brl.loverfreedatingapp.Profile.EditProfile.EditProfile_F;
import com.brl.loverfreedatingapp.Profile.Profile_Details.Profile_Details_F;
import com.brl.loverfreedatingapp.R;
import com.brl.loverfreedatingapp.Rating;
import com.brl.loverfreedatingapp.Settings.Setting_F;
...
public class Profile_F extends RootFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rating = new Rating(context);
        //rating.rateAlert();

        rateButton = view.findViewById(R.id.ratePanel);
